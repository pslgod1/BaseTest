...
import org.example.basetest.user.api.dto.auth.LoginRequest;
import org.example.basetest.user.api.dto.auth.RegisterCodeRequest;
import org.example.basetest.user.api.dto.auth.ResetPasswordRequest;
import org.example.basetest.user.api.dto.auth.VerifyRegisterRequest;
import org.example.basetest.user.domain.AuthService;
